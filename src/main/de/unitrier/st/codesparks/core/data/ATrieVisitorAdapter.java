...
public abstract class ATrieVisitorAdapter implements ITrieVisitor
{
    ...
    abstract AbstractGraphIterator<ArtifactTrieNode, ArtifactTrieEdge> getIterator(Graph<ArtifactTrieNode, ArtifactTrieEdge> graph);
