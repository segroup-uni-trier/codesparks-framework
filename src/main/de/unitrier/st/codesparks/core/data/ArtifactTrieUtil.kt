...
//        return 0
//    }
//    if (t1Node.nodeId == artifactIdentifier) {
//        return 1
//    }
//
...
//            if (childValue > 0) {
//                ret = 1
//                intersection.addVertex(t1Node.pathId, t1Node.nodeId, t1Node.label)
//                intersection.addVertex(targetT1.pathId, targetT1.nodeId, targetT1.label)
