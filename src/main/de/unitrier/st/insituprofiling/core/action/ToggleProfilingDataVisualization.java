package de.unitrier.st.insituprofiling.core.action;
...
public class ToggleProfilingDataVisualization extends AnAction
{
    private boolean visible;
    private final Icon visualizationVisibleIcon;
    private final Icon visualizationNotVisibleIcon;

    public ToggleProfilingDataVisualization()
    {
        visible = true;
