...
import static de.unitrier.st.insituprofiling.core.visualization.VisConstants.*;
...
public class DefaultArtifactCalleeVisualizationLabelFactory extends AArtifactCalleeVisualizationLabelFactory
{
            ...
            , Color metricColor)
    {
        ...
        BufferedImage bi = UIUtil.createImage(defaultConfiguration, CALLEE_X_OFFSET + INVOCATION_WIDTH + 7, lineHeight,
            ...
            for (Map.Entry<String, Double> entry : collect.entrySet())
            {
                ...
                MouseAdapter mouseAdapter = new MouseAdapter()
                {
                    ...
                    public void mouseEntered(MouseEvent e)
                    {
                        ...
                        int xoffset = (int) (INVOCATION_WIDTH * finalCalleeMetricSum / totalMetricValue);
                        Graphics graphics = visualizationLabel.getGraphics();
                        graphics.setColor(new JBColor(new Color(203, 119, 48), new Color(203, 119, 48)));
                        int width = (int) (INVOCATION_WIDTH * entry.getValue() / totalMetricValue);
                        graphics.drawRect(CALLEE_X_OFFSET + xoffset, CALLEE_Y_OFFSET, width, lineHeight - 6);
                        graphics.drawRect(CALLEE_X_OFFSET + xoffset + 1, CALLEE_Y_OFFSET + 1, width - 2, lineHeight - 8);
                    }
